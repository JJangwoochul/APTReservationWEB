                        ...
                        <div class="col-6">
                            <% if (isGuesthouse) { %>
                                <form name="realReserveForm" action="./processGuesthouse.jsp" method="post" class="m-0">
                                    ...
                                    <button type="button" class="btn btn-dark btn-lg w-100 fw-bold shadow-sm" onclick="confirmReservation()">
                                        예약확정
                                    </button>
                                </form>
                            <% } else { %>
                                <form name="realReserveForm" action="./processReserve.jsp" method="post" class="m-0">
                                    ...
                                    <input type="hidden" name="userNo" value="<%= userNo %>">
                                    <input type="hidden" name="reserveDate" value="<%= reserveDate %>">
                                    <button type="button" class="btn btn-primary btn-lg w-100 fw-bold shadow-sm" onclick="confirmReservation()">
                                        예약확정
                                    </button>
                                </form>
                            <% } %>
